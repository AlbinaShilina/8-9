...
public class Main // Класс, реализующий отображение из домашних животных.
{
    public static void main(String[] args) // Основная функция.
    {
        ...
        for (int i = 0; i < size_arrayCats; i++)
        {
            ...
            hashMap.put(arrayCats[i], new Cat(arrayCats[i])); // Добавление элементов массива arrayCats в массив hashMap.
        }
        System.out.println();
        ...
        for (int i = 0; i < size_arrayDogs; i++)
        {
            ...
            hashMap.put(arrayDogs[i], new Dog(arrayDogs[i])); // Добавление элементов массива arrayDogs в массив hashMap.
        }
        System.out.println();
        ...
        System.out.println("Добавлен кот \"Барсик\".");
        hashMap.put("!Пёс!", new Dog("Пёс"));
        System.out.println("Добавлен пёс \"Пёс\".");
        hashMap.put("!Каркуша!", new Owl("Каркуша"));
        System.out.println("Добавлена сова \"Каркуша\".");



        System.out.println("Создано отображение после добавления элементов:");
